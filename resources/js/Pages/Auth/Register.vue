        ...
        <div class="space-y-6">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="rounded-md bg-blue-50 p-3">
                    <p class="text-sm text-blue-700">Leave balances will be initialized based on current policies.</p>
                </div>

                <div class="flex flex-col gap-3 pt-2 sm:flex-row sm:justify-end">
                    <Link :href="route('login')" class="order-2 sm:order-1">
                        <SecondaryButton type="button" class="w-full sm:w-auto">Cancel</SecondaryButton>
                    </Link>
                    <PrimaryButton type="submit" :disabled="form.processing" class="order-1 w-full sm:order-2 sm:w-auto">
                        Register
                    </PrimaryButton>
                </div>
            </form>
