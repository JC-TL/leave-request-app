    ...
    <x-slot name="navigation">
        <nav class="navbar bg-base-100 shadow-sm border-b border-base-300 px-6 py-4 w-full">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('hr.policies') }}" class="btn btn-sm border-[#1EA1F1] text-[#1C96E1] hover:bg-[#00194F] hover:border-[#1C96E1] hover:text-white">Policies</a>
            ...
            <div class="card bg-base-100 shadow-sm border border-base-300">
                <div class="card-body">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <!-- Approve Form -->
                        <div class="flex-1">
                            <form action="{{ route('hr.approve-request', $leaveRequest->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                        ...
                        <!-- Reject Form -->
                        <div class="flex-1">
                            <form action="{{ route('hr.reject-request', $leaveRequest->id) }}" method="POST">
                                @csrf
                                @method('PATCH')
                                <div class="form-control mb-4">
                                    <label class="label">
